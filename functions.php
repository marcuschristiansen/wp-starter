...
function wp_starter_setup() {
	...
	register_nav_menus( array(
		'primary' => esc_html__( 'Primary', 'wp_starter' ),
	) );
...
function wp_starter_widgets_init() {
	register_sidebar( array(
		...
		'id'            => 'sidebar-1',
		'description'   => esc_html__( 'Add widgets here.', 'wp_starter' ),
...
function wp_starter_scripts() {
	...
	wp_enqueue_script( 'wp_starter-navigation', get_template_directory_uri() . '/js/navigation.js', array(), '20151215', true );

	wp_enqueue_script( 'wp_starter-skip-link-focus-fix', get_template_directory_uri() . '/js/skip-link-focus-fix.js', array(), '20151215', true );
